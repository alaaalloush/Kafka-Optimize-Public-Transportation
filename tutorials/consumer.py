...
async def consume(topic_name):
    ...
    while True:
		...
		# message = c.consume(5, timeout=1.0) ## consume allows to fetch multiple messages at once.
        if message is None:
...
def on_assign(consumer, partitions):
    ...
    for partition in partitions:
        partition.offset = OFFSET_BEGINNING ### ONLY WHEN CONSUMER HAS TO PROCESS ALL
